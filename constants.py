...
#【問題1】の追加箇所3つ
DB_REGULATION_PATH = "./.db_regulation"
DB_IT_MANUAL_PATH = "./.db_it_manual"
DB_SALES_FAQ_PATH = "./.db_sales_faq"
...
DB_NAMES = {
    ...
    #【問題1】の追加箇所3つ
    DB_REGULATION_PATH: f"{RAG_TOP_FOLDER_PATH}/regulation",
    DB_IT_MANUAL_PATH: f"{RAG_TOP_FOLDER_PATH}/it_manual",
    DB_SALES_FAQ_PATH: f"{RAG_TOP_FOLDER_PATH}/sales_faq",
}
...
#【問題1】の追加箇所3つ
#製品マニュアル
SEARCH_PRODUCT_MANUAL_TOOL_NAME = "search_product_manual"
SEARCH_PRODUCT_MANUAL_TOOL_DESCRIPTION = "製品・サービスのマニュアル（使い方・設定方法など）に関する情報を検索するときに使う"

#営業FAQ
SEARCH_SALES_FAQ_TOOL_NAME = "search_sales_faq"
SEARCH_SALES_FAQ_TOOL_DESCRIPTION = "営業FAQ（料金、契約条件、営業トークなど）に関する情報を検索するときに使う"

#クレーム/トラブル対応
SEARCH_TROUBLE_SUPPORT_TOOL_NAME = "search_trouble_support"
SEARCH_TROUBLE_SUPPORT_TOOL_DESCRIPTION = "クレームやトラブル対応に関するノウハウを検索したいときに使う"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - 選定した従業員が問い合わせ内容に対して適切であると判断した理由を生成してください。
